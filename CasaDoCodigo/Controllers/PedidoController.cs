...
namespace CasaDoCodigo.Controllers
{
    public class PedidoController : Controller
    {
		...
		public async Task<IActionResult> BuscaProdutos(string pesquisa)
		{
            ...
            {
                return base.View(new BuscaProdutosViewModel(await produtoRepository.GetProdutos(), pesquisa));
            }
            return base.View(new BuscaProdutosViewModel(await produtoRepository.GetProdutos(pesquisa), pesquisa));
